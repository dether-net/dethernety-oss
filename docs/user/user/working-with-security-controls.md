...
- **Intelligent protection**: Controls automatically generate appropriate countermeasures based on where they're applied
- **Universal application**: The same control adapts to provide contextual protection for different element types
- **Comprehensive coverage**: Mix technical, administrative, and process controls in single packages
...
- Assign multiple control class types to create comprehensive protection:
...
- Mix different control types for comprehensive protection

## Assigning Controls to Elements

### Universal Control Assignment

The power of Dethernety controls lies in their universal applicability. The same control can be assigned to different element types and automatically provides appropriate protection:
...
- **Model (Entire system)**: Generates comprehensive encryption policy countermeasures

This contextual intelligence means you can create consistent security standards while getting appropriate protection for each element type.
...
- Click the **creation icon with stars** (✨) in the top-right corner
...
**Benefits for Users**:
- **Confidence**: Know that controls address real-world attack techniques
- **Completeness**: Framework integration ensures comprehensive coverage
- **Traceability**: See exactly how controls protect against specific threats
- **Industry Standards**: Leverage established security frameworks automatically
...
**Next Steps:**
- **[Security Analysis Workflow](security-analysis-workflow.md)**: Run analysis to identify where controls are needed
- **[Issue Management Guide](issue-management-guide.md)**: Track control implementation as security improvements
- **[Building Your First Model](building-your-first-model.md)**: Practical model creation with control assignment