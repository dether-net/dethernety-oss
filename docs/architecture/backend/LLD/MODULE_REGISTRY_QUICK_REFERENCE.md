...
```typescript
// Get a module
const module = moduleRegistry.getModuleByName('dethernety-module');
...
```bash
# Successful load
[LOG] Module loaded successfully: dethernety-module v1.0.0
...
# Health check
[DEBUG] Module health check passed: dethernety-module
```
