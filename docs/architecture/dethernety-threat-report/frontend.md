...
offers three modes sharing one engine and one minimap: a **crown-jewel** mode that,
from a selectable origin (external entry points by default, or any node as an
