...
const AttributesSchema = z.object({
  ...
  dataFlows: z.record(z.any()).optional(),
  dataItems: z.record(z.any()).optional()
})
...
const InputSchema = z.object({
  ...
  data: z.union([z.string(), z.record(z.any())]).optional().describe('JSON data to validate (string or object)'),
