...
import ExtEntNode from '../ExtEntNode.vue'
...
describe('ExtEntNode — unclassified pill visibility', () => {
  it('shows pill when classId and representedModelId are both null', () => {
    const wrapper = mount(ExtEntNode, {
      props: { id: 'n-1', data: { label: 'User', classId: null, representedModelId: null } },
      global: { stubs },
    })
  ...
  it('hides pill when classId is set', () => {
    const wrapper = mount(ExtEntNode, {
      props: { id: 'n-1', data: { label: 'User', classId: 'cls-1', representedModelId: null } },
      global: { stubs },
    })
  ...
  it('hides pill when representedModelId is set', () => {
    const wrapper = mount(ExtEntNode, {
      props: { id: 'n-1', data: { label: 'User', classId: null, representedModelId: 'mdl-1' } },
      global: { stubs },
    })
    expect(wrapper.find('.unclassified-pill-stub').exists()).toBe(false)
  })
  ...
  it('hides pill when both classId and representedModelId are set', () => {
    const wrapper = mount(ExtEntNode, {
      props: { id: 'n-1', data: { label: 'User', classId: 'cls-1', representedModelId: 'mdl-1' } },
      global: { stubs },
    })
    expect(wrapper.find('.unclassified-pill-stub').exists()).toBe(false)
  })
